...
st.set_page_config(page_title='Capgemini DataPrepAI — Enterprise Data Preparation, Semantic Analytics & AI',page_icon='assets/dataprepai_logo.svg',layout='wide',initial_sidebar_state='expanded')
inject_base_css()
...
VIEWS={
'Home':'0_Home.py','Data Onboarding':'1_Data_Onboarding.py','Data Preparation':'14_Data_Preparation.py','AI Analysis':'2_AI_Analysis.py','Semantic Intelligence':'3_Semantic_Intelligence.py','Business Model':'4_Business_Model.py','QA Validation':'9_QA_Validation.py','Analytics':'5_Analytics.py','AI/BI Dashboard':'15_AI_BI_Dashboard.py','Ask AI':'6_Ask_AI.py','Genie Agent':'8_Genie.py','Security Center':'7_Security_Center.py','Databricks Discovery':'10_Databricks_Discovery.py','Connectors':'11_Connectors.py','Audit & Policies':'12_Audit.py'}
...
if not path.exists(): st.error(f'Missing DataPrepAI view: {path.name}'); st.stop()
